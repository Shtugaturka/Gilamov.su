                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            <td>
                                                ...
                                                <?php /* Slug*/ ?>
                                                @if($row->field == 'slug')
                                                    <a href="<?php echo $data->getUrl()?>"><?php echo $data->getUrl()?></a>
                                                @elseif($row->field == 'parent_id')
                                                <?php $category=\App\Models\Portfolio\Category::find($data->{$row->field}) ?>
                                                <?php if($category): ?>
                                                    <a href="<?php echo $category->getUrl()?>"><?php echo $category->getTitle()?></a>
                                                <?php else: ?>
