@extends('layouts.portfolio.category')
...
@section('content')
    ...
    <section class="portfolio-home-works">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="mb-4 text-center"><?php echo $hl ? $hl : $category->getTitle() ?></h1>
                </div>
            </div>
        </div>


        <?php if ($category->content && $works->currentPage() == 1): ?>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="lead mb-3">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="portfolio-category">
                        ...
                        <a class="btn <?php if($category->id==$_category->id):?>btn-outline-primary<?php else: ?>btn-outline-dark<?php endif;?> mb-2"  href="<?php echo $_category->getUrl()?>"><?php echo $_category->getTitle()?></a>
                        <?php endforeach; ?>
                    </div>
                </div>
            </div>
